...
export async function generatePoster(
    ...
    // 1. 整体背景：品牌棕渐变 → 暖白
    // ══════════════════════════════════════════
    // NOTE: 15 色标平滑渐变，与页面背景完全一致（50% 处到达暖白，下半段纯色）
    const bgGradient = ctx.createLinearGradient(0, 0, 0, H)
    bgGradient.addColorStop(0, '#7C4E3A')
    bgGradient.addColorStop(0.03, '#835A48')
    bgGradient.addColorStop(0.07, '#8F6756')
    bgGradient.addColorStop(0.11, '#9B7464')
    bgGradient.addColorStop(0.15, '#A88272')
    bgGradient.addColorStop(0.19, '#B59080')
    bgGradient.addColorStop(0.23, '#C2A090')
    bgGradient.addColorStop(0.27, '#CCAFA2')
    bgGradient.addColorStop(0.31, '#D6BFB4')
    bgGradient.addColorStop(0.35, '#DFCEC6')
    bgGradient.addColorStop(0.39, '#E8DDD8')
    bgGradient.addColorStop(0.43, '#F0EAE7')
    bgGradient.addColorStop(0.47, '#F6F2F0')
    bgGradient.addColorStop(0.50, '#FDF8F5')
